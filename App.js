...
import ManagerProfileInfo from './app/screens/manager/ManagerProfileInfo';
...
import AdminProfileInfo from './app/screens/admin/AdminProfileInfo';
...
import AdminUserDashboard from './app/screens/admin/employees/AdminUserDashboard';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Drawer.Screen name="ManagerProfileInfo" component={ManagerProfileInfo} />
        ...
        <Drawer.Screen name="AdminProfileInfo" component={AdminProfileInfo} />
        ...
        <Drawer.Screen name="AdminUserDashboard" component={AdminUserDashboard} />
      </Drawer.Navigator>
    </NavigationContainer>
  );
}
