...
function AdminProfileInfo(props) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            props.navigation.navigate('AdminProfileScreen', { user: userDetail })
        } catch (error) {
    ...
    return (
        <View>
            <AppBar {...props} menu={false} title="Personal Information" backAction={"AdminProfileScreen"} />
