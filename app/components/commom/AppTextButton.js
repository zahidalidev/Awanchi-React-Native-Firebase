...
function AppTextButton({ onLayout = null, disabled = false, name, icon, onSubmit, width, height = RFPercentage(6), borderRadius = 10, backgroundColor = "black", iconSize = 20, iconLeft, buttonStyle, textStyle }) {
    return (
